...
export default function Repere() {
  ...
  return (
    <div className='absolute h-full top-[700px] w-full justify-around grid grid-cols-2  sm:grid-cols-4  md:grid-cols-6  lg:grid-cols-10  xl:grid-cols-12 gap-[20px] px-[80px]  z-10'>
